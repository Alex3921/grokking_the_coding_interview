...
// The root (or the tree) with the minimum height will be called Minimum Height
// Tree (MHT). There can be multiple MHTs for a graph. In this problem, we need
// to find all those roots which give us MHTs. Write a method to find all MHTs of
